            ...
            <tbody>
             ...
             foreach($billing_items as $row){
                ...
                <input type="hidden" name="billing_item_id[]" value="<?php echo $row->billing_items_id; ?>">
                    ...
                    <td width="10">
                    <input type="checkbox" style="width: 26px;height: 26px;" id="tax<?php echo $counter ?>" disabled oninput="compute('<?php echo $counter; ?>', '<?php echo $row->billing_tax; ?>')" <?php echo ($rowResult['tax']) ? 'checked' : ''; ?>  name="tax[]" class="form-control">
